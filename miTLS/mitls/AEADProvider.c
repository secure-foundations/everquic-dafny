...
FStar_Pervasives_Native_snd___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(
  K____EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes x
)
{
  return x.snd;
}
...
AEADProvider_salt_of_state(
  TLSInfo_id i1,
  TLSConstants_rw r,
  K____EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes s
)
{
  return
    FStar_Pervasives_Native_snd__FStar_Bytes_bytes_FStar_Bytes_bytes(FStar_Pervasives_Native_snd___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(s));
}
...
{
  return
    FStar_Pervasives_Native_fst__FStar_Bytes_bytes_FStar_Bytes_bytes(FStar_Pervasives_Native_snd___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(s));
}
...
AEADProvider_create_nonce(
  TLSInfo_id i1,
  TLSConstants_rw rw,
  K____EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes st,
...
{
  return
    FStar_Pervasives_Native_snd___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(st);
}
...
)
{
  ...
  return
    ((K____EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes){ .fst = s, .snd = k1 });
}
...
*FStar_Pervasives_Native_fst___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(
  K____EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes x
)
{
  return x.fst;
...
AEADProvider_encrypt(
  TLSInfo_id i1,
  Prims_int l,
  K____EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes w,
...
)
{
  ...
  uint8_t *plain1 = lb1;
  EverCrypt_aead_encrypt(FStar_Pervasives_Native_fst___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(w),
    iv1,
    ad1,
    adlen1,
    plain1,
    ...
    cipher,
    tag);
  FStar_Bytes_bytes cipher_tag_res = FStar_Bytes_of_buffer(cipherlen1, (uint8_t *)cipher_tag);
...
)
{
  ...
  uint32_t
  ok =
    EverCrypt_aead_decrypt(FStar_Pervasives_Native_fst___EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(st),
      iv1,
      ad1,
      adlen1,
      plain,
  ...
  if (ok == (uint32_t)1U)
    return
      (
        (FStar_Pervasives_Native_option__FStar_Bytes_bytes){
          .tag = FStar_Pervasives_Native_Some,
          .v = FStar_Bytes_of_buffer(plainlen, (uint8_t *)plain)
        }
      );
  else
    return
