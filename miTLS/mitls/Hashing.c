...
HMAC_hmac(Spec_Hash_Definitions_hash_alg a, FStar_Bytes_bytes k1, FStar_Bytes_bytes m)
{
  ...
  FStar_Bytes_bytes t1 = FStar_Bytes_of_buffer(lt1, (uint8_t *)bt);
  return t1;
}
...
)
{
  ...
  FStar_Bytes_bytes tag = FStar_Bytes_of_buffer(len1, (uint8_t *)tag_p);
  return tag;
}
...
FStar_Bytes_bytes Hashing_compute(Spec_Hash_Definitions_hash_alg a, FStar_Bytes_bytes text)
{
  ...
  FStar_Bytes_bytes t1 = FStar_Bytes_of_buffer(tlen, (uint8_t *)output);
  return t1;
}
