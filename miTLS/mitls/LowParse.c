...
LowParse_SLow_BoundedInt_parse32_bounded_integer_2(FStar_Bytes_bytes input)
{
  ...
  else
  {
    ...
    uint8_t last1 = FStar_Bytes_get(s_, (uint32_t)1U);
    FStar_Bytes_bytes first1 = FStar_Bytes_slice(s_, (uint32_t)0U, (uint32_t)1U);
    uint8_t last2 = FStar_Bytes_get(first1, (uint32_t)0U);
    FStar_Bytes_bytes first2 = FStar_Bytes_slice(first1, (uint32_t)0U, (uint32_t)0U);
    uint32_t n1 = (uint32_t)0U;
    uint32_t blast0 = (uint32_t)last2;
    uint32_t n10 = blast0 + n1 * (uint32_t)256U;
    uint32_t blast = (uint32_t)last1;
    return
      (
        (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = blast + n10 * (uint32_t)256U, .snd = (uint32_t)2U }
        }
      );
  }
}
...
{
  uint8_t lo = (uint8_t)input;
  FStar_Bytes_bytes seq_hi = FStar_Bytes_empty_bytes;
  FStar_Bytes_bytes seq_lo = FStar_Bytes_create((uint32_t)1U, lo);
  return FStar_Bytes_append(seq_hi, seq_lo);
}

FStar_Bytes_bytes LowParse_SLow_BoundedInt_serialize32_bounded_integer_2(uint32_t input)
{
  uint8_t lo = (uint8_t)input;
  uint32_t hi = input / (uint32_t)256U;
  uint8_t lo1 = (uint8_t)hi;
  FStar_Bytes_bytes seq_hi = FStar_Bytes_empty_bytes;
  FStar_Bytes_bytes seq_lo0 = FStar_Bytes_create((uint32_t)1U, lo1);
  FStar_Bytes_bytes seq_hi0 = FStar_Bytes_append(seq_hi, seq_lo0);
  FStar_Bytes_bytes seq_lo = FStar_Bytes_create((uint32_t)1U, lo);
  return FStar_Bytes_append(seq_hi0, seq_lo);
}
...
LowParse_SLow_Int_parse32_u16(FStar_Bytes_bytes input)
{
  ...
  else
  {
    ...
    uint8_t last2 = FStar_Bytes_get(first1, (uint32_t)0U);
    FStar_Bytes_bytes first2 = FStar_Bytes_slice(first1, (uint32_t)0U, (uint32_t)0U);
    uint16_t n1 = (uint16_t)0U;
    uint16_t blast0 = (uint16_t)last2;
    uint16_t n10 = blast0 + n1 * (uint16_t)256U;
    uint16_t blast = (uint16_t)last1;
    return
      (
        (FStar_Pervasives_Native_option__K___uint16_t_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = { .fst = blast + n10 * (uint16_t)256U, .snd = (uint32_t)2U }
        }
      );
  }
}
...
{
  uint8_t lo = (uint8_t)input;
  uint16_t hi = input / (uint16_t)256U;
  uint8_t lo1 = (uint8_t)hi;
  FStar_Bytes_bytes seq_hi = FStar_Bytes_empty_bytes;
  FStar_Bytes_bytes seq_lo0 = FStar_Bytes_create((uint32_t)1U, lo1);
  FStar_Bytes_bytes seq_hi0 = FStar_Bytes_append(seq_hi, seq_lo0);
